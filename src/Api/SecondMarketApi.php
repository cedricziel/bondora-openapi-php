...
class SecondMarketApi
{
    ...
    /**
     * Operation secondMarketGetItemList_0
     *
     * Get the secondary market item summaries in a list
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\SecondMarketListingRequest $request SecondaryMarket item identificators.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultSecondMarketItemSummaryList
     */
    public function secondMarketGetItemList_0($request)
    {
        list($response) = $this->secondMarketGetItemList_0WithHttpInfo($request);
        return $response;
    }

    /**
     * Operation secondMarketGetItemList_0WithHttpInfo
     *
     * Get the secondary market item summaries in a list
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\SecondMarketListingRequest $request SecondaryMarket item identificators.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return array of \CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultSecondMarketItemSummaryList, HTTP status code, HTTP response headers (array of strings)
     */
    public function secondMarketGetItemList_0WithHttpInfo($request)
    {
        $request = $this->secondMarketGetItemList_0Request($request);
    ...
    /**
     * Operation secondMarketGetItemList_0Async
     *
     * Get the secondary market item summaries in a list
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\SecondMarketListingRequest $request SecondaryMarket item identificators.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secondMarketGetItemList_0Async($request)
    {
        return $this->secondMarketGetItemList_0AsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation secondMarketGetItemList_0AsyncWithHttpInfo
     *
     * Get the secondary market item summaries in a list
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\SecondMarketListingRequest $request SecondaryMarket item identificators.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secondMarketGetItemList_0AsyncWithHttpInfo($request)
    {
        $returnType = '\CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultSecondMarketItemSummaryList';
        $request = $this->secondMarketGetItemList_0Request($request);
    ...
    /**
     * Create request for operation 'secondMarketGetItemList_0'
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\SecondMarketListingRequest $request SecondaryMarket item identificators.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function secondMarketGetItemList_0Request($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling secondMarketGetItemList_0'
            );
        }
    ...
    /**
     * Operation secondMarketGetList_0
     *
     * Gets LoanPartDetails info by identifiers in a list (up to 1000 items).
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\LoanPartDetailsRequest $request LoanPartDetails identifiers list.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultLoanPartDetailsList
     */
    public function secondMarketGetList_0($request)
    {
        list($response) = $this->secondMarketGetList_0WithHttpInfo($request);
        return $response;
    }

    /**
     * Operation secondMarketGetList_0WithHttpInfo
     *
     * Gets LoanPartDetails info by identifiers in a list (up to 1000 items).
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\LoanPartDetailsRequest $request LoanPartDetails identifiers list.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return array of \CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultLoanPartDetailsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function secondMarketGetList_0WithHttpInfo($request)
    {
        $request = $this->secondMarketGetList_0Request($request);
    ...
    /**
     * Operation secondMarketGetList_0Async
     *
     * Gets LoanPartDetails info by identifiers in a list (up to 1000 items).
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\LoanPartDetailsRequest $request LoanPartDetails identifiers list.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secondMarketGetList_0Async($request)
    {
        return $this->secondMarketGetList_0AsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation secondMarketGetList_0AsyncWithHttpInfo
     *
     * Gets LoanPartDetails info by identifiers in a list (up to 1000 items).
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\LoanPartDetailsRequest $request LoanPartDetails identifiers list.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secondMarketGetList_0AsyncWithHttpInfo($request)
    {
        $returnType = '\CedricZiel\OpenAPI\BondoraPHP\Model\ApiResultLoanPartDetailsList';
        $request = $this->secondMarketGetList_0Request($request);
    ...
    /**
     * Create request for operation 'secondMarketGetList_0'
     *
     * @param  \CedricZiel\OpenAPI\BondoraPHP\Model\LoanPartDetailsRequest $request LoanPartDetails identifiers list.              This endpoint supports both GET and POST methods.              If using this endpoint with the GET method the request data must be sent with the request body, even though it is a GET request.              The \&quot;Content-Type\&quot; header must be set so the server knows how to decode the data. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function secondMarketGetList_0Request($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling secondMarketGetList_0'
            );
        }
