...
/**
 * ApiResultBids Class Doc Comment
 *
 * @category Class
 * @package  CedricZiel\OpenAPI\BondoraPHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApiResultBids implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResultBids';
    ...
    protected static $openAPITypes = [
        ...
        'totalCount' => 'int',
        'count' => 'int',
        'payload' => '\CedricZiel\OpenAPI\BondoraPHP\Model\BidSummary[]',
        'success' => 'bool',
    ...
    public function setPageSize($pageSize)
    {
        ...
        if (!is_null($pageSize) && ($pageSize > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pageSize when calling ApiResultBids., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pageSize) && ($pageSize < 0)) {
            throw new \InvalidArgumentException('invalid value for $pageSize when calling ApiResultBids., must be bigger than or equal to 0.');
        }
    ...
    public function setPageNr($pageNr)
    {
        ...
        if (!is_null($pageNr) && ($pageNr > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pageNr when calling ApiResultBids., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pageNr) && ($pageNr < 1)) {
            throw new \InvalidArgumentException('invalid value for $pageNr when calling ApiResultBids., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalCount($totalCount)
    {
        ...
        if (($totalCount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $totalCount when calling ApiResultBids., must be smaller than or equal to 2147483647.');
        }
        if (($totalCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $totalCount when calling ApiResultBids., must be bigger than or equal to 0.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ApiResultBids., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ApiResultBids., must be bigger than or equal to 0.');
        }
     ...
     * Gets payload
     *
     * @return \CedricZiel\OpenAPI\BondoraPHP\Model\BidSummary[]|null
     */
     ...
     * Sets payload
     *
     * @param \CedricZiel\OpenAPI\BondoraPHP\Model\BidSummary[]|null $payload The payload of the response. Type depends on the API request.
     *
     * @return $this
     */
