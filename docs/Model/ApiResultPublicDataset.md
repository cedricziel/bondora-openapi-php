...
**payload** | [**\CedricZiel\OpenAPI\BondoraPHP\Model\PublicDatasetItem[]**](PublicDatasetItem.md) | The payload of the response. Type depends on the API request. | [optional] 
